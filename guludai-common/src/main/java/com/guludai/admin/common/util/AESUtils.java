...
public class AESUtils {
    ...
    public static void main(String[] args) {
        String text = AESUtils.encryptData("F431E6FF9051DA07","测试123410=");
        System.out.println("aes加密密后" + text);

        String plainText = AESUtils.decryptData("F431E6FF9051DA07", text);
        System.out.println("aes解密密后: " + plainText);
    }
}
